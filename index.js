...
async function run() {
    try {
        ...
        app.get("/unions", async (req, res) => {
            const result = await unionsCollection.find().toArray();
            res.send(result);
        });
